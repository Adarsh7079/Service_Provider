...
import { IoMdBusiness, IoMdBriefcase } from "react-icons/io";
...
const Admin = () => {
  ...
  const callAbout = async () => {
    try {
      const res = await fetch("http://localhost:4000/service/v1/admin/me", {
        method: "GET",
        headers: {
  ...
  console.log("get dqata ", data);

  return (
    <div className="flex flex-col  mt-32 mb-[100px] px-[15%]   ">
      <div className=" ">
        <div className=" flex ">
          <img
            ...
            alt="image"
            className=" w-[150px] h-[150px] rounded-full border-2 flex items-center justify-center"
          />
          <div
            onClick={(e) => setEdit(!isEdit)}
            className=" w-[50px] bg-gray-400 h-[50px] rounded-full flex text-gray-100 font-medium text-xl items-center justify-center"
          >
            <FiEdit3 />
          </div>
        </div>
         ...
         <div className=" flex justify-between">
          ...
          <div className=" flex flex-col gap-3 w-[300px]">
            <div className=" flex font-medium  text-gray-500 ">
              <div className=" flex items-center text-gray-500 gap-2 w-[200px]">
                <MdOutlinePerson2 className=" w-5 h-5" />
                <div>Full Name :</div>
              </div>
            ...
            <div className=" flex font-medium  text-gray-500 ">
              <div className=" flex items-center text-gray-500 gap-2 w-[200px]">
                <FaAddressCard className=" w-5 h-4" />
            ...
            <div className=" flex font-medium  text-gray-500 ">
              <div className=" flex items-center text-gray-500 gap-2 w-[200px]">
                <IoMdBriefcase className=" w-5 h-4" />
                <div>Job Type :</div>
              </div>
            ...
            <div className=" flex font-medium   text-gray-500">
              <div className=" flex items-center text-gray-500 gap-2 w-[200px]">
                <IoMdBusiness className=" w-5 h-4" />
                <div>Work Experience :</div>
              </div>
              <div>{data.Work_Experience}</div>
            </div>
            <div className=" flex font-medium  text-gray-500">
              <div className=" flex items-center text-gray-500 gap-2 w-[200px]">
                <MdOutlinePerson2 className=" w-5 h-5" />
